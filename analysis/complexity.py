...
def sam_based_count(rgb_image, model_path = None):
    model = SAM(os.path.join(model_path, "sam_b.pt"))
...
def get_info(observation):
    ...
    for scaling_factor in scaling_factors:
        ...
        img_stats['ellipse_details'][f'scaling_{scaling_factor}'] = {
                ...
                'objects_distances_mapping': objects_distances
            }
